...
mod tests {
    ...
    fn test_extract_event_name() {
        ...
        assert_eq!(extract_event_name(&input_camel), Some("PreToolUse".to_string()));
        
        // Test snake_case
        let input_snake = json!({
            "hook_event_name": "PostToolUse"
        });
        assert_eq!(extract_event_name(&input_snake), Some("PostToolUse".to_string()));
        ...
        assert_eq!(extract_event_name(&input_both), Some("PreToolUse".to_string()));
    }
