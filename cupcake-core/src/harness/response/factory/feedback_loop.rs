...
/// for Factory AI's self-correction feedback loops
        ...
        match decision {
            ...
            EngineDecision::Allow { .. } | EngineDecision::Ask { .. } => {
                ...
                match hook_event {
                    ...
                    FactoryEvent::Stop(_) | FactoryEvent::SubagentStop(_) => {
...
mod tests {
    ...
    fn create_common_data() -> CommonFactoryData {
        CommonFactoryData {
    ...
    fn test_feedback_loop_block() {
        ...
        let event = FactoryEvent::PostToolUse(PostToolUsePayload {
    ...
    fn test_feedback_loop_allow() {
        ...
        let event = FactoryEvent::Stop(StopPayload {
            common: create_common_data(),
    ...
    fn test_post_tool_use_with_context() {
        ...
        // Test JSON wire format matches Factory AI hook contract
    ...
    fn test_feedback_loop_with_suppress() {
        ...
        let event = FactoryEvent::SubagentStop(SubagentStopPayload {
            common: create_common_data(),
            stop_hook_active: false,
        });
    ...
    fn test_feedback_loop_events() {
        ...
        let events = vec![
            (
                "PostToolUse",
                FactoryEvent::PostToolUse(PostToolUsePayload {
                    common: create_common_data(),
                    tool_name: "Bash".to_string(),
                    tool_input: json!({"command": "ls"}),
                    tool_response: json!({"success": true}),
            ...
            (
                "SubagentStop",
                FactoryEvent::SubagentStop(SubagentStopPayload {
                    common: create_common_data(),
                    stop_hook_active: false,
                }),
            ),
