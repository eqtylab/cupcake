//! Core shell execution functionality tests
//!
//! This test suite validates the fundamental shell execution capabilities including
//! template substitution, command graph building, and execution results.
