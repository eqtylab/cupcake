...
fn test_composed_policy_serialization() {
    ...
    assert_eq!(deserialized.conditions.len(), composed_policy.conditions.len());
}
...
fn test_condition_variants_yaml_serialization() {
    ...
    for condition in conditions {
        let yaml_str = serde_yaml_ng::to_string(&condition).expect("Failed to serialize condition to YAML");
...
fn test_action_variants_yaml_serialization() {
    ...
    for action in actions {
        let yaml_str = serde_yaml_ng::to_string(&action).expect("Failed to serialize action to YAML");
...
fn test_hook_event_types_yaml_serialization() {
    ...
    let yaml_str = serde_yaml_ng::to_string(&policy).expect("Failed to serialize policy with hook event");
    ...
    for event_type in hook_events {
        ...
        let deserialized: ComposedPolicy = serde_yaml_ng::from_str(&yaml_str).expect("Failed to deserialize policy");
...
fn test_state_query_filter_yaml_serialization() {
    ...
    let yaml_str = serde_yaml_ng::to_string(&query).expect("Failed to serialize state query filter");
...
fn test_complex_yaml_policy_serialization() {
    ...
    let yaml_str = serde_yaml_ng::to_string(&yaml_policy).expect("Failed to serialize complex YAML policy");
    let deserialized: YamlPolicy =
...
fn test_round_trip_yaml_serialization() {
    ...
    assert_eq!(deser_write_policies[0].description, orig_write_policies[0].description);
}
...
"#;
    ...
    let fragment: PolicyFragment = serde_yaml_ng::from_str(yaml_content)
        .expect("Failed to parse real-world YAML fragment");
